...
def main(args):
	...
	if args.pretrained:
		...
		del checkpoint["model"]["input_proj.weight"]; del checkpoint["model"]["input_proj.bias"]
	...
	data_loader_train = DataLoader(dataset_train, batch_sampler=batch_sampler_train,
								   collate_fn=utils.collateHyperData, num_workers=args.num_workers)
	data_loader_val = DataLoader(dataset_val, args.batch_size, sampler=sampler_val,
								 drop_last=False, collate_fn=utils.collateHyperData, num_workers=args.num_workers)
	...
	for epoch in range(args.start_epoch, args.epochs):
		...
		test_stats = evaluate(args.dataset_file,
